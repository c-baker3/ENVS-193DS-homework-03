...
In analyzing my personal data, I found that the duration of my workouts varies more for runs than for lifting, surfing, and yoga. I also found that the more I sleep the night prior, the more likely I am to go on a run compared to doing a lift, surf, or yoga workout. With these observations in mind, I'm planning to make an affective visualization focused on the relationship between a longer duration of sleep and an increased number of runs. My current plan is to create a drawing where I'm dreaming of running (see the sketch below)!  
